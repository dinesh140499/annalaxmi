        ...
        subCategory: [
            {
                ...
                link: "/categories",
                children: [
                    { name: "Toor / Arhar Dal", link: "/categories/1" },
                    { name: "Moong Dal (Split & Whole)", link: "/categories/6" },
                    { name: "Chana Dal & Kabuli", link: "/categories" },
                    { name: "Urad Dal (Black & White)", link: "/categories" },
                ],
            },
            { name: "Organic Rajma & Chana", link: "/categories" },
            { name: "Native Lentils Mix", link: "/categories" },
        ],
    },
    {
        id: 2,
        ...
        subCategory: [
            { name: "Traditional Rice Varieties", link: "/categories/2" },
            { name: "Foxtail & Finger Millets", link: "/categories/7" },
            { name: "Stone-Ground Atta & Flour", link: "/categories" },
            { name: "Jowar & Bajra", link: "/categories" },
        ],
    },
    {
        id: 3,
        ...
        subCategory: [
            { name: "Kachi Ghani Mustard Oil", link: "/categories/3" },
            { name: "Virgin Wood-Pressed Coconut Oil", link: "/categories" },
            { name: "Cold-Pressed Sesame & Groundnut", link: "/categories" },
        ],
    },
    {
        id: 4,
        ...
        subCategory: [
            { name: "Salem Turmeric Powder", link: "/categories/4" },
            { name: "Kashmiri Chilli & Pepper", link: "/categories/8" },
            { name: "Aromatic Whole Spices", link: "/categories" },
        ],
    },
    {
        id: 5,
        ...
        subCategory: [
            { name: "Kashmiri Mamra Almonds", link: "/categories/5" },
            { name: "Walnut Kernels & Cashews", link: "/categories" },
            { name: "Raw Chia & Pumpkin Seeds", link: "/categories" },
        ],
    },
];
